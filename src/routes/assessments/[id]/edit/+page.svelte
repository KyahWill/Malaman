<script lang="ts">
  ...
  import {
    AssessmentBuilder,
    AssessmentPreview,
  } from "$lib/components/instructor/index.js";
  ...
  async function handleSave(assessment: Assessment) {
    try {
      saving = true;
...
<div class="container mx-auto px-4 py-8">
  ...
  {:else if error}
    ...
    <Card class="p-8 text-center">
      ...
      <div class="space-x-2">
        <Button onclick={loadAssessment} variant="primary">Try Again</Button>
  ...
  {:else if assessment}
    ...
    <div class="mb-8">
      <div class="flex items-center space-x-2 text-sm text-gray-600 mb-2">
        ...
        <span>›</span>
        <a href="/assessments/{assessmentId}" class="hover:text-blue-600"
          >{assessment.title}</a
        >
        <span>›</span>
        <span>Edit</span>
